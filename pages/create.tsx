...
>
  ...
  <section style={{ padding: "2rem 1rem" }}>
    <h2 style={{ fontSize: "1.8rem", marginBottom: "1rem", color: "#155E63", textAlign: "center" }}>Welcome to Pipcasso Dice Mosaic Generator</h2>
    <p style={{ fontSize: "1rem", lineHeight: "1", marginBottom: "2rem", maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
