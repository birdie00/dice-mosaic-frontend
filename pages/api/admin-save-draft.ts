...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Store as { grid, rotations } object so get-grid can return rotations to /build
  const gridDataString = JSON.stringify({ grid, rotations: rotations ?? null });
