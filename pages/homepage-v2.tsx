    ...
    <Layout hero={hero}>
      ...
      <section style={{ backgroundColor: DARK, color: WHITE, padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <p style={{ textAlign: "center", color: GOLD, fontWeight: 700, letterSpacing: 3, fontSize: "0.8rem", textTransform: "uppercase", marginBottom: "0.5rem" }}>
            The Process
          </p>
          <h2
            style={{
            ...
            {[
              {
                ...
                desc: "Choose any photo of a person, pet, or place",
                img: "/images/photo-tips.png",
              },
              {
                step: "02",
                title: "We Generate Your Mosaic",
                desc: "Our algorithm maps your photo to a 7-color dice palette instantly",
                img: "/images/build-mode.png",
              },
              {
                step: "03",
                title: "Build or Buy",
              ...
              <div key={item.step} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <h3 style={{ fontWeight: 700, fontSize: "1.1rem", color: WHITE, margin: 0 }}>{item.title}</h3>
                <p style={{ color: "#ccc", fontSize: "0.92rem", lineHeight: 1.6, margin: 0 }}>{item.desc}</p>
                <div style={{ borderRadius: 12, overflow: "hidden", marginTop: "0.5rem" }}>
                  <img
                    src={item.img}
                    alt={item.title}
